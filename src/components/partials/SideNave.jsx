...
const SideNave = () => {
  ...
  return (
    <>
      <div onClick={handleMenue} className='text-lg text-white left-5 top-3 font-medium absolute z-50 select-none'>Menu</div>


      {!openMenue ? (
        <div className='p-4 w-[18%] h-screen sticky top-10 shadow '>
          <div>
